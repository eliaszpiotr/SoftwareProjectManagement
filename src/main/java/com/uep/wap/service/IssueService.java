...
import com.uep.wap.model.IssueStatus;
import com.uep.wap.model.IssueType;
...
public class IssueService {
    ...
    @Transactional
    public Issue createIssue(Long projectId, String title, String description, IssueStatus status, IssueType type) {
    ...
    @Transactional
    public Issue updateIssue(Long issueId, String title, String description, IssueStatus status, IssueType type) {
